...
**4**. در صورت استفاده از پارامترهای SHYY  و MIYY  در قالب شماره دهی، هنگام شماره دهی دستی آیتم می‌توان از سال 1357 (میلادی از 1980) الی یک سال پس از سال جاری، آیتم را شماره گذاری کرد.
